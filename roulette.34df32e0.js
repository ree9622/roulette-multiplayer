   ...
   */ showJoinRoomModal() {
      ...
      <div class="mp-modal-form">
        ...
        <label>
          ...
          <input type="text" id="mp-room-code" placeholder="6\u{C790}\u{B9AC} \u{BC29} \u{CF54}\u{B4DC}" maxlength="6" style="text-transform: uppercase;" />
        </label>
...
},{"./PeerManager":"jSfm7","./RoomManager":"lWYrr","./GameSync":"31mqk","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jSfm7":[function(require,module,exports,__globalThis) {
/**
 * PeerManager 클래스
   ...
   */ async connectToHost(hostId) {
        return new Promise((resolve, reject)=>{
            ...
            try {
                ...
                // 타임아웃 설정 (10초)
                setTimeout(()=>{
                    if (!conn.open) reject(new Error("\uC5F0\uACB0 \uC2DC\uAC04 \uCD08\uACFC"));
                }, 10000);
            } catch (error) {
                reject(error);
            }
...
},{"peerjs":"8QkfH","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8QkfH":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./protocol":"j4Qj9","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["9ZvZc","gH3Lb"], "gH3Lb", "parcelRequire5cc2", {}, "./", "/")
